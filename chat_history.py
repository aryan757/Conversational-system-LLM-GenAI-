...
def display_follow_up_questions(intent_classification):
    ...
    if intent_classification in follow_up_questions:
        ...
        if st.session_state.follow_up_index < len(questions):
            ...
            st.session_state.chat_history.append(message(f"🕵️‍♀️ {question}", is_user=False))
            st.write(f"🕵️‍♀️ {question}")
...
# Streamlit front-end
st.set_page_config(page_title="Police सेवा Portal System (Conversational)", page_icon=":police_officer:")

# Display greeting message
if not st.session_state.chat_history:
    st.session_state.chat_history.append(message("🕵️‍♀️ Hello! Welcome to the Police सेवा Portal System. How can I assist you today?", is_user=False))
...
if user_input and not st.session_state.get('intent_classification'):
    ...
    try:
        ...
        st.session_state.chat_history.append(message(f"🕵️‍♀️ {result}", is_user=False))
