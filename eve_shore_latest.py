...
def analyze_query(user_query, user_name, user_phone):
    ...
    chain = LLMChain(
        llm=HuggingFaceHub(repo_id='mistralai/Mistral-7B-Instruct-v0.2', model_kwargs={'temperature': 0.5, 'max_new_tokens': 250}),
        prompt=prompt
    )
...
st.sidebar.subheader("Upload an Image (Optional)")
st.sidebar.text("If you have an image related to the incident, you can upload it here. This step is optional.")
