...
def analyze_query(user_query, user_location, user_name, user_phone, category):
    ...
    result = chain.run(user_query=user_query, user_location=user_location, user_name=user_name, user_phone=user_phone, category=category)  # Pass user_name, user_phone, and category here
    return result
...
if st.button("Analyze Query"):
    if user_query:
        ...
        try:
            result = analyze_query(user_query, user_location, user_name, user_phone, selected_category)
            # Display the results
            ...
            with open('user_data.csv', mode='a', newline='') as file:
                ...
                writer.writerow([user_name, user_phone, user_query, selected_category, intent_classification, other_details])
